# A Time Server Library for Arduino Uno # [![Build Status](https://travis-ci.com/mirzafahad/time_server_arduino.svg?branch=master)](https://travis-ci.com/mirzafahad/time_server_arduino)
